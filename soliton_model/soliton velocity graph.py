...
def animatevelocity(j):
    ...
    if j > stop3:
       ...
       # txt1.set_text("j = %s" %j)
    return uanim, massanim, vanim, ampanim, wave1, wave2, wave3
...
plt.axis([xmin, xmax, -0.1, 1.1*12*max(alpha)**2])
