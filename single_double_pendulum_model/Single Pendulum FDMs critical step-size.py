...
"""
find_critical_step_length = 'y'    #'Y' or 'y' for yes, anything else for no.
critical_step_start = 10         #Start must be bigger than end.  
critical_step_end = 0.01
number_of_steps = 500
energy_percentage = 20 #Units of %. Usually 1 is a good value. Only used for undamped non-appoximated single-pendulum and undamped double pendulum.
...
h = 1             #If h is small, the number of calculation increases. This also slows down the animation. Ignore this if you are finding critical step-size.
...
subplot4 = fig.add_subplot(2,1,2)
